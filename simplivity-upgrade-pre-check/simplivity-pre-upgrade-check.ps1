...
function Invoke-SVT {
   ...
   # Define the path to variable file
	...
	{
		Write-Host "Copying Modules to C:\Users\$($Env:UserName)\Documents\WindowsPowerShell\Modules Directory.. "
		...
		Write-Host "Loading modules :  HPESimpliVity ,VMware.PowerCLIs, Posh-SSH "
